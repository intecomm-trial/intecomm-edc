...
class Migration(migrations.Migration):
    dependencies = [
        ...
        (
            "intecomm_subject",
            "0040_alter_historicalhivmedicationadherence_options_and_more",
        ),
    ]

    operations = [
        migrations.CreateModel(
            name="HistoricalHealthEconomicsBaseline",
            fields=[
                (
                    "revision",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=25,
                        verbose_name="If the owner [you] were to sell this dwelling today, do you know theapproximate value?",
                    ),
                ),
                (
                    "dwelling_value",
                ...
                (
                    "external_dependents",
                    models.IntegerField(
                        help_text="Insert 0 if no dependents other than the members in the household roster in Section 1.",
            ...
            options={
                "verbose_name": "historical Heath economics baseline",
                "verbose_name_plural": "historical Heath economics baseline",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="intecomm_su_subject_595eb7_idx",
                    ),
                    models.Index(
                        fields=["subject_visit", "report_datetime"],
                        name="intecomm_su_subject_dfb9d5_idx",
                    ),
                ],
            },
            managers=[
