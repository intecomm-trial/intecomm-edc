...
qa_cases = [
    CrfCase(
        ...
        dbtable="intecomm_subject_patienthistory",
        label_lower="intecomm_subject.patienthistory",
    ...
    CrfCase(
        ...
        list_tables=[("current_arv_regimen_id", "intecomm_lists_arvregimens", "arvregimen")],
    ),
    CrfCase(
        label="FBG/OGTT: missing OGTT",
        dbtable="intecomm_subject_glucose",
        label_lower="intecomm_subject.glucose",
        where=(
