...
from intecomm_dashboard.navbars import navbar as intecomm_dashboard_navbar
...
navbar.append_item(
    [item for item in intecomm_dashboard_navbar.items if item.name == "screened_subject"][0]
)
