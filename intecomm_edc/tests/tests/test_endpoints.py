...
# from meta_screening.constants import FBG
...
#         fbg_datetime = part_three_data.get(f"{FBG}_datetime")
...
#                 f"{FBG}_datetime_0": fbg_datetime.strftime("%Y-%m-%d"),
#                 f"{FBG}_datetime_1": fbg_datetime.strftime("%H:%M"),
