    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ae_cause_other', edc_model_fields.fields.other_charfield.OtherCharField(blank=True, max_length=250, null=True, verbose_name='If "Yes", specify')),
                ...
                ('ae_awareness_date', models.DateField(default=edc_utils.date.get_utcnow, validators=[edc_model.models.validators.date.date_not_future], verbose_name='AE Awareness date')),
                ('ae_start_date', models.DateField(default=edc_utils.date.get_utcnow, validators=[edc_model.models.validators.date.date_not_future], verbose_name='Actual Start Date of AE')),
                ...
                ('study_drug_relation', models.CharField(choices=[('not_related', 'Not related'), ('unlikely_related', 'Unlikely related'), ('possibly_related', 'Possibly related'), ('probably_related', 'Probably related'), ('definitely_related', 'Definitely related'), ('N/A', 'Not applicable')], max_length=25, null=True, verbose_name='Relation to study drug:')),
                ...
                ('ae_classification', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_adverse_event.aeclassification', verbose_name='Adverse Event (AE) Classification')),
                ...
                ('sae_reason', models.ForeignKey(help_text='If subject deceased, submit a Death Report', on_delete=django.db.models.deletion.PROTECT, to='edc_adverse_event.saereason', verbose_name='If "Yes", reason for SAE:')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_action_identifier', models.CharField(blank=True, help_text='action identifier that links to related reference model instance.', max_length=30, null=True)),
                ('action_item_reason', models.TextField(editable=False, null=True)),
                ('report_datetime', models.DateTimeField(default=edc_utils.date.get_utcnow, validators=[edc_protocol.validators.datetime_not_before_study_start, edc_model.models.validators.date.datetime_not_future], verbose_name='Report Date')),
                ('death_datetime', models.DateTimeField(null=True, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Date and Time of Death')),
                ('death_date', models.DateField(null=True, validators=[edc_model.models.validators.date.date_not_future], verbose_name='Date of Death')),
                ...
                ('parent_action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.actionitem')),
                ('related_action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.actionitem')),
                ('secondary_cause_of_death', models.ForeignKey(help_text='Secondary cause of death in the opinion of the local study doctor and local PI', on_delete=django.db.models.deletion.PROTECT, related_name='secondary_cause_of_death', to='edc_adverse_event.causeofdeath', verbose_name='Secondary cause of death')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('related_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('secondary_cause_of_death', models.ForeignKey(blank=True, db_constraint=False, help_text='Secondary cause of death in the opinion of the local study doctor and local PI', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_adverse_event.causeofdeath', verbose_name='Secondary cause of death')),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_utils.date.get_utcnow, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Report date and time')),
                ('ae_received_datetime', models.DateTimeField(blank=True, null=True, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Date and time AE form received:')),
                ('clinical_review_datetime', models.DateTimeField(blank=True, null=True, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Date and time of clinical review: ')),
                ...
                ('narrative', models.TextField(blank=True, null=True, verbose_name='Narrative')),
                ('officials_notified', models.DateTimeField(blank=True, null=True, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Date and time regulatory authorities notified (SUSARs)')),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('report_datetime', models.DateTimeField(default=edc_utils.date.get_utcnow, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Report date and time')),
                ('submitted_datetime', models.DateTimeField(blank=True, null=True, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='AE SUSAR submitted on')),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('ae_classification', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_adverse_event.aeclassification', verbose_name='Adverse Event (AE) Classification')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('parent_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('related_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('sae_reason', models.ForeignKey(blank=True, db_constraint=False, help_text='If subject deceased, submit a Death Report', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_adverse_event.saereason', verbose_name='If "Yes", reason for SAE:')),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outcome_date', models.DateField(validators=[edc_model.models.validators.date.date_not_future])),
        ...
        migrations.CreateModel(
            ...
            managers=[
                ('on_site', edc_adverse_event.model_mixins.death_report.death_report_tmg_model_mixin.DeathReportTmgSecondSiteManager()),
                ('objects', edc_adverse_event.model_mixins.death_report.death_report_tmg_model_mixin.DeathReportTmgSecondManager()),
            ],
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='intecomm_ae_subject_222cd1_idx'),
        ),
        migrations.AddIndex(
