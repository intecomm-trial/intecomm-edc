...
@admin.register(CommunityCareLocation, site=intecomm_prn_admin)
class CommunityCareLocationAdmin(
    ...
    change_list_template: str = "intecomm_prn/admin/communitycarelocation_change_list.html"
    ...
    def meetings(self, obj=None):
        url = reverse("intecomm_prn_admin:intecomm_prn_patientgroupappointment_changelist")
