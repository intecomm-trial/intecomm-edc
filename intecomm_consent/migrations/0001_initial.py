    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', django_crypto_fields.fields.firstname_field.FirstnameField(blank=True, help_text='Use UPPERCASE letters only. (Encryption: RSA local)', max_length=71, null=True, validators=[django.core.validators.RegexValidator(message='Ensure name consist of letters only in upper case', regex='^([A-Z]+$|[A-Z]+\\ [A-Z]+)$')])),
                ('last_name', django_crypto_fields.fields.lastname_field.LastnameField(blank=True, help_text='Use UPPERCASE letters only. (Encryption: RSA local)', max_length=71, null=True, validators=[django.core.validators.RegexValidator(message='Ensure name consist of letters only in upper case', regex='^([A-Z]+$|[A-Z]+\\ [A-Z]+)$')], verbose_name='Surname')),
                ...
                ('language', models.CharField(choices=[['lg', 'Luganda'], ['ry', 'Runyakitara'], ['en', 'English'], ['sw', 'Swahili']], help_text='The language used for the consent process will also be used during data collection.', max_length=25, verbose_name='Language of consent')),
                ('consent_datetime', models.DateTimeField(validators=[edc_protocol.validators.datetime_not_before_study_start, edc_model.validators.date.datetime_not_future], verbose_name='Consent date and time')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_identifier', 'first_name', 'dob', 'initials', 'version'], name='intecomm_co_subject_145905_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='subjectconsent',
            unique_together={('subject_identifier', 'version'), ('first_name', 'dob', 'initials', 'version'), ('subject_identifier', 'screening_identifier')},
        ),
    ]
