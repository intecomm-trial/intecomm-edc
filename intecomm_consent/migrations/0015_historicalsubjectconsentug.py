...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("intecomm_consent", "0014_alter_subjectconsentug_options"),
    ]

    operations = [
        migrations.CreateModel(
            name="HistoricalSubjectConsentUg",
            fields=[
                (
                    "revision",
            ...
            options={
                "verbose_name": "historical Subject Consent (Uganda)",
                "verbose_name_plural": "historical Subject Consents (Uganda)",
