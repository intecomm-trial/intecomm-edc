...
class Migration(migrations.Migration):
    dependencies = [
        (
            "intecomm_screening",
            "0068_alter_consentrefusal_site_alter_healthtalklog_site_and_more",
        ),
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="HistoricalSubjectScreeningTz",
            fields=[
                (
                    "revision",
            ...
            options={
                "verbose_name": "historical Subject Screening (Tanzania)",
                "verbose_name_plural": "historical Subject Screening (Tanzania)",
