    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eligible_part_one', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('tbd', 'To be determined')], default='tbd', editable=False, help_text='system calculated value', max_length=15)),
                ('reasons_ineligible_part_one', models.TextField(editable=False, max_length=150, null=True)),
                ('eligible_part_two', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('tbd', 'To be determined')], default='tbd', editable=False, help_text='system calculated value', max_length=15)),
                ('reasons_ineligible_part_two', models.TextField(editable=False, max_length=150, null=True)),
